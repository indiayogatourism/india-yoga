...
export default async function PackagesPage({ searchParams }: PageProps) {
  ...
  return (
    <main className="pt-32 pb-section-padding-desktop">
      ...
      {/* Filters Section */}
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-12 mb-12 sm:mb-16">
        <div className="flex flex-col gap-4 items-center justify-center">
          {/* Category Filters (Horizontal Scroll on Mobile) */}
          <div className="w-full overflow-x-auto no-scrollbar pb-2">
            <div className="flex sm:flex-wrap justify-start sm:justify-center gap-2.5 min-w-max sm:min-w-0 px-2 sm:px-0">
              <Link
                href={getFilterUrl('category', '')}
                className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-full font-body-md text-xs sm:text-sm border transition-all shrink-0 ${
                  !categoryParam
          ...
          {/* Duration Filters (Horizontal Scroll on Mobile) */}
          <div className="w-full overflow-x-auto no-scrollbar pb-1">
            <div className="flex sm:flex-wrap justify-start sm:justify-center gap-2 min-w-max sm:min-w-0 px-2 sm:px-0">
              <Link
                href={getFilterUrl('duration', '')}
                className={`px-3.5 sm:px-4 py-1.5 sm:py-2 rounded-full font-body-md text-xs border transition-all shrink-0 ${
                  !durationParam
