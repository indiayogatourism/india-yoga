    ...
    const newPackage = await prisma.package.create({
      data: {
        ...
        upcomingDates: Array.isArray(upcomingDates)
          ...
          : [],
        priceDormitory: priceDormitory !== undefined && priceDormitory !== null && priceDormitory !== "" ? Number(priceDormitory) : null,
        priceShared: Number(priceShared) || 1499,
        pricePrivate: Number(pricePrivate) || 2199,
        enableDormitory: Boolean(enableDormitory),
        enableShared: enableShared !== undefined ? Boolean(enableShared) : true,
        enablePrivate: enablePrivate !== undefined ? Boolean(enablePrivate) : true,
