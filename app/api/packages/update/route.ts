  ...
  try {
    ...
    const updatedPackage = await prisma.package.update({
      ...
      data: {
        ...
        ...(priceDormitory !== undefined && { priceDormitory: priceDormitory !== null && priceDormitory !== "" ? Number(priceDormitory) : null }),
        ...
        ...(enableDormitory !== undefined && { enableDormitory: Boolean(enableDormitory) }),
        ...(enableShared !== undefined && { enableShared: Boolean(enableShared) }),
        ...(enablePrivate !== undefined && { enablePrivate: Boolean(enablePrivate) }),
